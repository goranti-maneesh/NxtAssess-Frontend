...
export const McqQuestionDetails = styled.div`
	${tw`h-92per bg-white shadow-assessmentPage flex flex-col pb-12`}
`;
...
export const SubmitTestBtn = styled.button`
	${tw`mt-auto border border-solid border-ChathamsBlue outline-none rounded-4px text-fs16_lh24 text-ChathamsBlue mr-4 ml-4 h-12`}
`;
